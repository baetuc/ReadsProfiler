...
public:
    ...
    static const char* concatenateStrings(const char* first, const char* second, const char* third);
};
...
const char* Utility::concatenateStrings(const char* first, const char* second, const char* third) {
    string result = first;
    result += second;
    result += third;
    return result.c_str();
